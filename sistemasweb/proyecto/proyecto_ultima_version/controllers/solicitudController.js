...
const solicitudController = {
    ...
    postSolicitud: async (req, res, next) => {
        //separa las respuestas y evita exponer informacion innecesaria
        const isAjax = req.headers['x-requested-with'] === 'XMLHttpRequest';

        try {
            // --- Sanitización de entradas ---
            //Evita ataques de XSS y ejecucion de JS convirtiendo caracteres HTML peligrosos.
            ...
            //manejo de errores, evita que la aplicación muestre errores internos directamente al usuario
        } catch (e) {
            if (isAjax) {
