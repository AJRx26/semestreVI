...
const Solicitud = {
    create: async (data) => {
        ...
        //Se usa ? como placeholders para quq eusuario no pueda modificar el SQL 
    ...
    count: async () => {
        //el usuario no puede modificar la consulta porque no recibe parámetros externos.
    ...
    //Se asigna 5 como limite para evitar que alguien pueda modificar la consulta
