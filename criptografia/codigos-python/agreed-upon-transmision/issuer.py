...
if __name__ == '__main__':
    ...
    llave_publica_subject = utils_maestro.regresar_bytes(path_subject_public)
    contenido = utils_maestro.regresar_bytes(path_issuer_private)
    llave_privada_issuer = generarLlaves.convertir_bytes_llave_privada(contenido)
